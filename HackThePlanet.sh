...
sleep 1
echo ""
echo -e "$White [${Green} ++ ${White}]$Green Credits to ${White}: ${Red}SilentGhostX${White} &&${Red} AKAS${White} &&${Red} Fantome195${White} ."
echo ""
exit
}
exit_function() {
...
echo ""
echo ""
echo -e "$White [${Cyan}!$White] Remove any temporary file ."
rm -rf ${Temporary}
sleep 1
echo ""
if [ "$mode_monitor" == "active" ]
    then
        echo -e "$White [${Green}!${White}]$BRed Stop$White the ${Green}Monitor Mode$White."
        ifconfig $mon down && iwconfig $mon mode managed && ifconfig $mon up > /dev/null 2> /dev/null &
        echo ""
fi
echo -e "$White [+]$Green Credits to : ${Red}SilentGhostX${White} &&${Red} AKAS${White} &&${Red} Fantome195${White} ."
echo -e "$DefaultColor"
exit
}
kill_wep_function() {
					...
					IVs=20000
					echo ""
	                echo -e "          ${Yellow}>>${White} The Cracking process has${Yellow} stoped${White} , G00D LuCk Next Time ."
	                echo -e "          ${Yellow}>>${White} Kill all processes running in${Green} background${White} ."
					echo ""
					echo -e "$White          [${Cyan}!${White}]$White Sorry password not found , good luck next time."
...
kill_Hidden() {
	                ...
	                echo ""
	                echo ""
	                echo -e "          ${Yellow}>>${White} The Cracking process has${Green} stoped${White} , G00D LuCk Next Time ."
	                echo -e "          ${Yellow}>>${White} Kill all processes running in${Yellow} background${White} ."
					echo ""
					echo -e "$White          [${BRed}!${White}]$White Sorry Name not found , good luck next time ."
                 ...
                 if [ $VerCar -ge 1 ] && [ "$VerMon" = "" ]
                      then
						   ...
						   while [ "$V_number" != "1" ]
								 do
								   echo -en "\033[1A\033[2K"
						           echo -e -n "${White}[+] Select number$White of wireless device to put into$Green monitor mode$White [${Green}1-${NUM_INT_CHIP}$White]:$Green"
						           read number
								   if [[ "$number" =~ ^[+-]?[0-9]+$ ]]
									  then
...
End_OF_THE_SCRIPT(){
					...
					sleep 0.1
					echo -e "             ##   ${Cyan}-Author   ${White}:      {${Yellow} Do0p H2ck ${White}}                ${Green}##"
					sleep 0.1
...
echo -e "     |$Yellow           MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM      |"  
sleep 0.1
echo -e "     |$Blue           MMMMMMMMWd. .kWMMMMMMMMMMMMMMMMMMMMMMW0KMMMMMMMMMM      |" 
sleep 0.1
echo -e "     |$Blue           MMMMMMMMk:;. 'OMMMMMMMMMMMMMMMMMMMMMWx.,0MMMMMMMMM      |" 
sleep 0.1
echo -e "     |$Blue           MMMMMMMK:ok.  ,0MMMMMMMMMMMMMMMMMMMWO. .cXMMMMMMMM      |"  
sleep 0.1
echo -e "     |$Blue           MMMMMMNl:KO.   ;KWNXK00O0000KXNWMMWO' .c;dWMMMMMMM      |"  
sleep 0.1
echo -e "     |$Blue           MMMMMMx,xNk.    .;'...    ....';:l:.  ,0l,0MMMMMMM      |"  
sleep 0.1
echo -e "     |$Blue           MMMMMK;,l;. .,:cc:;.                  .dx,lWMMMMMM      |" 
sleep 0.1
echo -e "     |$Blue           MMMMWo    ,dKWMMMMWXk:.      .cdkOOxo,. ...OMMMMMM      |" 
sleep 0.1
echo -e "     |$Blue           MMMM0'   cXMMWKxood0WWk.   .lkONMMNOOXO,   lWMMMMM      |" 
sleep 0.1 
echo -e "     |$Blue           MMMWl   ;XMMNo.    .lXWd. .dWk;;dd;;kWM0'  '0MMMMM      |"  
sleep 0.1
echo -e "     |$Blue           kxko.   lWMMO.      .kMO. .OMMK;  .kMMMNc   oWMMMM      |"   
sleep 0.1
echo -e "     |$Blue           X0k:.   ;KMMXc      :XWo  .dW0c,lo;;xNMK,   'xkkk0      |"  
sleep 0.1
echo -e "     |$Blue           kko'     :KMMNkl::lkNNd.   .dkdKWMNOkXO,    .lOKNW      |"  
sleep 0.1
echo -e "     |$Blue           0Kk:.     .lOXWMMWN0d,       'lxO0Oko;.     .ckkOO      |"
sleep 0.1   
echo -e "     |$Blue           kkkdodo;.    .,;;;'.  .:ooc.     .        ...ck0XN      |"  
sleep 0.1
echo -e "     |$Blue           0XWMMMMWKxc'.          ;dxc.          .,cxKK0OkkOO      |"
sleep 0.1
echo -e "     |$Blue           MMMMMMMMMMMN0d:'.  .'        .l'  .;lxKWMMMMMMMMMN      |"  
sleep 0.1
echo -e "     |$Blue           MMMMMMMMMMMMMMMN0xo0O:,;;;;;;xN0xOXWMMMMMMMMMMMMMM      |"  
sleep 0.1 
echo -e "     |$Yellow           MMMMMMMMMMMMMMMMMMMMMMWWWWWMMMMMMMMMMMMMMMMMMMMMMM      |"  
sleep 0.1
echo -e "     |$Yellow           MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM      |"  
sleep 0.1
echo -e "     |$Yellow           MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM      |"  
...
sleep 0.1
echo -e "                          |${BRed} Hack${BYellow}     The${BPurple}    Planet${BGreen}${Yellow} |"
sleep 0.1
echo -e "                          ${Cyan}+${Yellow}------------------------${Cyan}+"
sleep 0.1
Ver_User=`whoami`
...
echo -e "${White}     | ${Red}[${Yellow}04${Red}]${White} |$Green If you want to crack an acces point's key with WPS PIN${White} .   |"
echo -e "${White}     | ${Red}[${Yellow}05${Red}]${White} |$Green If you want to crack Hidden$Green acces point${White} .                |"
...
echo -e "${Yellow}     +${White}-------------------------------------------------------------------${Yellow}+"
echo ""
echo -e -n "$White    ${Red} [${Cyan}!${Red}]$White Type the ID$White of your choice : "
read menu
